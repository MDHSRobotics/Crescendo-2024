...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        if (driverController != null) {
            s_Swerve.setDefaultCommand(s_Swerve.applyRequest(() -> drive.withVelocityX(getVelocityX())
    ...
    private void configureDriverButtonBindings() {
        ...
        */
        ...
        driverController
                .options()
                .onTrue(s_Swerve.runOnce(s_Swerve::seedFieldRelative).withName("Reset Robot Perspective"));

        // Slow mode
        driverController
                .L2()
                .whileTrue(s_Swerve.applyRequest(() -> driveSlow
    ...
    private void configureOperatorButtonBindings() {
        ...
        */
        ...
        operatorController
                .leftTrigger()
                .toggleOnTrue(
                        Commands.race(s_Intake.intakeNoteCommand(IntakePositions.BOTTOM), s_Shooter.intakeNoteCommand())
                                .withName("Run Intake at Bottom Position"));

        // Lock on to speaker (old method using limelight)
        operatorController
                .b()
                .toggleOnTrue(Commands.race(
                                s_Swerve.applyRequest(() -> drive.withVelocityX(getVelocityX())
                                        .withVelocityY(getVelocityY())
