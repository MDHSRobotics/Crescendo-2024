...
public class Shooter extends SubsystemBase{
  ...
  public void setAngleFromLimelight(){
    if(tagInSight()){
      ...
      double horizontalDistance = Aiming.calculateDistance(
          ...
          LimelightHelpers.getTY("limelight-front"));
  ...
  public void logShuffleboard(){
    ...
    limelightTY.setDouble(LimelightHelpers.getTY("limelight-front"));
    limelightTX.setDouble(LimelightHelpers.getTX("limelight-front"));
