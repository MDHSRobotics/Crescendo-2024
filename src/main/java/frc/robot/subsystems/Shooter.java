...
public class Shooter extends SubsystemBase {
  ...
  private GenericEntry calculatedAngle = tab.add("Calculated angle", 0.0).withSize(2, 1).getEntry();
  ...
  private GenericEntry isAtAngle = mainTab.add("At Angle", false).withSize(1, 1).getEntry();
  private GenericEntry seeTag = mainTab.add("Sees Tag ", false).withSize(2, 1).getEntry();
  private GenericEntry txCorrect = mainTab.add("TX Correct", false).withSize(2, 1).getEntry();
  ...
  public void setAngle(double targetAngle, boolean isAngleCalculated) {
    ...
    double rotations =
        ShooterConstants.kDegreesToRotationsConversion
            * (targetAngle - ShooterConstants.kBottomMeasureAngle);
  ...
  public void logData() {
    ...
    angleDegrees.setDouble(
        m_angleEncoder.getPosition() / ShooterConstants.kDegreesToRotationsConversion
    ...
    txCorrect.setBoolean(
        Aiming.approximatelyEqual(LimelightHelpers.getTX("limelight-front"), 0, 3));
