          ...
          this.runOnce(
              () -> {
                ...
                m_pidController.setReference(
                    intakeTopRotations.getDouble(0), CANSparkMax.ControlType.kPosition);
              });
    } else {
      disableIntakeCommand =
          this.runOnce(
        ...
        intakeNoteCommand =
            this.runOnce(
                () -> {
                  ...
                  conveyor.set(1);
                  m_pidController.setReference(
                      intakeBottomRotations.getDouble(0), CANSparkMax.ControlType.kPosition);
                });
        break;
      default: // MID:
        intakeNoteCommand =
  ...
  public Command ejectNoteCommand() {
    return this.runOnce(
            () -> {
              ...
              conveyor.set(-1);
              m_pidController.setReference(
                  intakeEjectRotations.getDouble(0), CANSparkMax.ControlType.kPosition);
            })
