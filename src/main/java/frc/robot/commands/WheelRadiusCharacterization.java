 ...
 * To be sure that the steer motor position does not cause any inaccuracies, run this as soon as you turn on the robot.
...
public class WheelRadiusCharacterization extends Command {
    ...
    private final NetworkTable table = inst.getTable("Drive").getSubTable("Wheel Radius Characterization");
    private final DoublePublisher averageWheelPositionPublisher = table.getDoubleTopic("Average Wheel Position").publish();
    private final DoublePublisher totalYawPublisher = table.getDoubleTopic("Total Yaw Radians").publish();
    private final DoublePublisher wheelRadiusPublisher = table.getDoubleTopic("Current Wheel Radius Inches").publish();
    ...
    public void execute() {
        ...
        double currentEffectiveWheelRadiusMeters = (totalGyroYawRadians * TunerConstants.kDriveBaseRadius) / averageWheelPosition;
