...
// See these links for TunerConstants examples:
// https://pro.docs.ctr-electronics.com/en/stable/docs/api-reference/mechanisms/swerve/swerve-builder-api.html#full-example
// https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/SwerveWithPathPlanner/src/main/java/frc/robot/generated/TunerConstants.java
public class TunerConstants {
  ...
  // We currently have this tuned to a value that lessens brownouts by a fair amount.
  ...
  // Our current free speed is MK4i, L3, Falcon 500, no FOC:
  ...
  // This is the inverse of the 1st stage of the drive motor, according to this link:
  // https://v6.docs.ctr-electronics.com/en/stable/docs/api-reference/mechanisms/swerve/swerve-builder-api.html#additional-constants
  // Our 1st stage is the L3 1st stage:
  // https://www.swervedrivespecialties.com/products/mk4i-swerve-module
  ...
  // Front Right
  public static final int kFrontRightDriveMotorId = 21;
  private static final int kFrontRightSteerMotorId = 20;
  private static final int kFrontRightEncoderId = 3;
  private static final double kFrontRightEncoderOffset = -0.249755859375;
  ...
  private static final double kBackLeftEncoderOffset = -0.249755859375;
  ...
  private static final double kBackRightEncoderOffset = -0.3857421875;
